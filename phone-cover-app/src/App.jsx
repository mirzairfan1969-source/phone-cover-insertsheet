...
const PhoneCoverApp = () => {
  ...
  const renderPreview = () => {
    ...
    if (sheetsPerPage === 2) {
      ...
      drawPhoneOnCanvas(ctx, pos1, phoneWidth, phoneHeight);
      drawPhoneOnCanvas(ctx, pos2, phoneWidth, phoneHeight);
    } else {
      const pos1 = { x: margin, y: margin };
      ...
      drawPhoneOnCanvas(ctx, pos1, phoneWidth, phoneHeight);
      drawPhoneOnCanvas(ctx, pos2, phoneWidth, phoneHeight);
      drawPhoneOnCanvas(ctx, pos3, phoneWidth, phoneHeight);
      drawPhoneOnCanvas(ctx, pos4, phoneWidth, phoneHeight);
    }
  };

  useEffect(() => {
    if (showPreview && image && currentPhone) {
      renderPreview();
    }
  }, [image, offsetX, offsetY, scale, sheetsPerPage, showPreview, currentPhone]);
        ...
        {!showPreview ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div style={{ background: '#334155', padding: '20px', borderRadius: '10px', border: '1px solid #475569' }}>
              ...
              {currentPhone && (
                <p style={{ fontSize: '12px', color: '#94a3b8', marginTop: '10px' }}>
                  {currentPhone.width.toFixed(1)}mm x {currentPhone.height.toFixed(1)}mm
                </p>
              )}
            </div>
            ...
            <div style={{ background: '#334155', padding: '20px', borderRadius: '10px', border: '1px solid #475569' }}>
              ...
              >
                <div style={{ fontWeight: 'bold' }}>Upload Image</div>
